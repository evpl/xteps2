...
final class FailedTestWithSuccessHooksTest {
  ...
  void hooks() {
    ...
    new XtepsJUnit5().addHook(5, () -> this.hooksInvocations.add(2));
    new XtepsJUnit5().addHook(9, () -> this.hooksInvocations.add(3));
    new XtepsJUnit5().addHook(9, () -> this.hooksInvocations.add(4));
  ...
  void check() {
    ...
    assertThat(this.extension.exception())
