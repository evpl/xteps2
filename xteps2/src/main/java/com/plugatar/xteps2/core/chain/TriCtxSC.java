...
public interface TriCtxSC<C1, C2, C3> extends BaseTriCtxSC<C1, C2, C3, TriCtxSC<C1, C2, C3>> {
  ...
  @Override
  <R1, R2, R3> TriCtxSC<R1, R2, R3> map(final ThTriFunction<? super C1, ? super C2, ? super C3, ? extends R1, ?> mapper1,
  ...
  class Of<C1, C2, C3> implements TriCtxSC<C1, C2, C3> {
    ...
    @Override
    public final <R1, R2, R3> TriCtxSC<R1, R2, R3> map(final ThTriFunction<? super C1, ? super C2, ? super C3, ? extends R1, ?> mapper1,
                                                       final ThTriFunction<? super C1, ? super C2, ? super C3, ? extends R2, ?> mapper2,
                                                       final ThTriFunction<? super C1, ? super C2, ? super C3, ? extends R3, ?> mapper3) {
