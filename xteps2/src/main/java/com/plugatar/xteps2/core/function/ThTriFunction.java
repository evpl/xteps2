...
public interface ThTriFunction<T, U, V, R, E extends Throwable> {
  ...
  /**
   * Returns given {@code ThTriFunction} as unchecked or null if {@code function} arg is null.
   *
   ...
   * @return unchecked {@code ThTriFunction} or null
   */
  @SuppressWarnings("unchecked")
  static <T, U, V, R> ThTriFunction<T, U, V, R, RuntimeException> unchecked(final ThTriFunction<? super T, ? super U, ? super V, ? extends R, ?> function) {
    return (ThTriFunction<T, U, V, R, RuntimeException>) function;
  }
}
