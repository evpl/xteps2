...
public interface ThTriConsumer<T, U, V, E extends Throwable> {
  ...
  /**
   * Returns given {@code ThTriConsumer} as unchecked or null if {@code consumer} arg is null.
   *
   ...
   * @return unchecked {@code ThTriConsumer} or null
   */
  @SuppressWarnings("unchecked")
  static <T, U, V> ThTriConsumer<T, U, V, RuntimeException> unchecked(final ThTriConsumer<? super T, ? super U, ? super V, ?> consumer) {
    return (ThTriConsumer<T, U, V, RuntimeException>) consumer;
  }
}
