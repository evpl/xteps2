...
public interface TriFunctionStep<C1, C2, C3, R> extends
  ...
  @Override
  TriFunctionStep<C1, C2, C3, R> withArtifact(String name,
                                              Object value);
  ...
  class Of<C1, C2, C3, R> implements TriFunctionStep<C1, C2, C3, R> {
    ...
    public final R apply(final C1 c1,
                         final C2 c2,
                         final C3 c3) {
      return this.stepReporter.executeStep(artifactsWithContexts(this.artifacts, new Object[]{c1, c2, c3}),
        () -> this.action.apply(c1, c2, c3));
    }
    ...
    @Override
    public final TriFunctionStep<C1, C2, C3, R> withArtifact(final String name,
                                                             final Object value) {
      return new TriFunctionStep.Of<>(this.stepReporter, copyMapAndPutArgs(this.artifacts, name, value), this.action);
    }
